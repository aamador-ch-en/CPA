...
${OBJECTDIR}/Adsorcion.o: Adsorcion.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/Adsorcion.o Adsorcion.f90

${OBJECTDIR}/CPA.o: CPA.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/CPA.o CPA.f90

${OBJECTDIR}/Constantes.o: Constantes.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/Constantes.o Constantes.f90

${OBJECTDIR}/Fugac.o: Fugac.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/Fugac.o Fugac.f90

${OBJECTDIR}/Matriz.o: Matriz.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/Matriz.o Matriz.f90

${OBJECTDIR}/VolStab.o: VolStab.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/VolStab.o VolStab.f90
